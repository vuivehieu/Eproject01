...
<html>
<head>
	<title>Diaries - Ryana Calendar</title>
	<meta charset="UTF-8">
		...
		<div class="header">
				...
				<div class="header-container" id="header-container">
					<div class="header-left">
						<a href="index.html"><img class="logo" src="site_logo.png"></a>
					</div>
					<div class="navbar">
						...
						<!-- Dropdown megamenu -->
				      	<div class="dropdown">
						    <button class="dropbtn"><a href="calendar.html">Calendar</a>
						    ...
						    <div class="dropdown-content">
						    	...
						    	<div class="mega-row">
							        ...
							        <div class="mega-col">
							        	...
							        	<img class="mega-img" src="calendar.jpg">
						    	</div>
						    </div>
						</div> 
						<div class="dropdown">
						    <button class="dropbtn"><a href="diary.html">Diary</a>
						      	<i class="fa fa-caret-down"></i>
						    </button>
						    <div class="dropdown-content">
								<div class="mega-header">
						    	...
						    	<div class="mega-row">
							        ...
							        <div class="mega-col">
							        	...
							        	<img class="mega-img" src="notebook.jpg">
						    	</div>
						    </div>
						</div> 
						<div class="dropdown">
						    <button class="dropbtn"><a href="pen.html">Pen</a>
						      	<i class="fa fa-caret-down"></i>
						    </button>
						    <div class="dropdown-content">
								<div class="mega-header">
						    	...
						    	<div class="mega-row">
							        ...
							        <div class="mega-col">
							        	...
							        	<img class="mega-img" src="pen.jpg">
						    	</div>
						    </div>
						</div>
  					</div>
  					<div class="header-right">
  						<a href="#facebook"><img src="search.svg"></a>
						<a href="contactus.html"><img src="map-pin.svg"></a>
						<!-- login sidebar -->
						<a href="#facebook" onclick="openNav()"><img src="user.svg"></a>
						<a href="#facebook"><img src="shopping-bag.svg"></a>
  					</div>
				</div>
		...
		<div class="intro-container">
			<div class="intro-left" style="background-color: #384254;">
				<div class="intro-content">
					<div class="intro-title">DIARIES AND PLANNERS</div>
					<div class="intro-sub">The next chapter of your life starts here! Stay on top of your schedule with the perfect diary for you, and make the most of your time with Ryana Calendar.</div>
				</div>
			</div>
...
<!-- Product list======== -->
		...
		<div class="product">
			<div class="product-row">
				<div class="product1">
					<div class="product-card">
						<img src="cat.jpg" alt="Cat Diary" style="width: 250px; height: ">
					  	<p class="product-brand">Iconic</p>
					  	<p class="product-name" style="font-family: mallory;">ICONIC 2021 CAT DIARY</p><br>
					  	<p class="price">$17.99</p><br>
					</div>
				</div>
				<div class="product2">
					<div class="product-card">
						<img src="midori.jpg" alt="Cat Diary" style="width: 250px;">
					  	<p class="product-brand">Midori</p>
					  	<p class="product-name" style="font-family: mallory;">MD Notebook Diary</p><br>
					  	<p class="price">$5.99</p><br>
					</div>
				</div>
				<div class="product3">
					<div class="product-card">
						<img src="refill.png" alt="Cat Diary" style="width: 250px;">
					  	<p class="product-brand">Traveler's Notebook</p>
					  	<p class="product-name" style="font-family: mallory;">TRAVELER'S NOTEBOOK // REFILL 017</p><br>
					  	<p class="price">$15.99</p><br>
					</div>
				</div>
				<div class="product4">
					<div class="product-card">
						<img src="completist.jpg" alt="Cat Diary" style="width: 250px;">
					  	<p class="product-brand">Completist</p>
					  	<p class="product-name" style="font-family: mallory;">Completist Weekly Planner</p><br>
					  	<p class="price">$17.99</p><br>
					</div>
				</div>
			</div>
			<div class="product-row">
				<div class="product1">
					<div class="product-card">
						<img src="2022.jpeg" alt="Cat Diary" style="width: 250px;">
					  	<p class="product-brand">Completist</p>
					  	<p class="product-name" style="font-family: mallory;">2022 Planner</p><br>
					  	<p class="price">$17.99</p><br>
					</div>
				</div>
				<div class="product2">
					<div class="product-card">
						<img src="cat.jpg" alt="Cat Diary" style="width: 250px;">
					  	<p class="product-brand">Iconic</p>
					  	<p class="product-name" style="font-family: mallory;">ICONIC 2021 CAT DIARY</p><br>
					  	<p class="price">$17.99</p><br>
					</div>
...
<!-- Guarantee Section -->
			<div class="section-4">
				...
				<div class="section-4-row">
					...
					<div class="section-4-col">
						<img class="section-4-img" src="gift.svg">
						<p>Best discounts</p>
					</div>
					<div class="section-4-col">
						<img class="section-4-img" src="check-circle.svg">
						<p>Secure shopping</p>
					</div>
				</div>
			</div>
		...
		<div class="footer">
			<div class="row">
				<div class="footer1">
					...
					<div class="readmore">
						<a style="text-decoration: none; font-family: mallory; font-size: 14px;" href="about.html">Read more...</a>
					</div>
				</div>
				<div class="footer2">
					<h5>Shop</h5>
				...
				<div class="footer3">
					...
					<div class="social">
						<a href="#facebook"><img src="facebook.svg"></a>
						<a href="#facebook"><img src="instagram.svg"></a>
						<a href="#facebook"><img src="twitter.svg"></a>
						<a href="#facebook"><img src="pinterest.svg"></a>
					</div>
				</div>
				<div class="footer4">
					<h5>Office</h5>
...
<!-- ========== open navbar============ -->
    <script>
		function openNav() {
		  ...
		  // document.getElementById("blurOverlay").style.opacity = "0.5";
